...
For understanding better how [defoe](https://github.com/defoe-code/defoe) works, we recommend to read first [this](https://ieeexplore.ieee.org/document/9041813) paper, along with checking [how to run defoe queries](https://github.com/defoe-code/defoe/blob/master/docs/run-queries.md) and [how to specify data to queries](https://github.com/defoe-code/defoe/blob/master/docs/specify-data-to-query.md) documentation. 
